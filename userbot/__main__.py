...
async def a():
    ...
    LOGS.info(
        f"Sucessfully connected with {o}{o2}{o3}{o4} check it by typing !javes in any client's chat, type  .help for more info. For official plugin channel for javes 2.0 got to @J2plugins and for more expirementaal plugin goto @plugines Also U Should Thank to All Contributers in repo:https://github.com/Javes786/javes-2.0"
    )
