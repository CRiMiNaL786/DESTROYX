...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "Javes User"
...
async def cmd_list(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        if tgbotusername is None or input_str == "text":
            ...
            help_string = f"""`Userbot Helper for {DEFAULTUSER} to reveal all the commands of `**[Javes -2.0](https://github.com/Javes786/javes-2.0)**\n\n"""
            try:
